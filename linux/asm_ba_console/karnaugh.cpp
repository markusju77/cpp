...
int tyhjienlkm = 0;
//extern std::unordered_map<int, int> taulukko5;
// g++ mielest? n?m? ovat kaksoisarvoja
// Taulukko5 on Karnaughin kartta
std::unordered_map<int, int> taulukko51;
// Iterator12 on Karnaughin kartta
std::unordered_map<int, int>::iterator it21;
...
void tulostaTaulukko(int lkm, int mlkm) {
	if (lkm == 4) {
		for (int b = 0; b < lkm; b++) {
			it21 = taulukko51.find(arvotNelja[b]);
			//cout << it21->second;
			//if (b == 1) cout << endl;
		}
	}
		...
		for (int b = 0; b < lkm; b++) {
			it21 = taulukko51.find(arvotKasi[b]);
			//cout << it21->second;
			//if (b == 3) cout << endl;
		}
	}
		...
		for (int b = 0; b < lkm; b++) {
			it21 = taulukko51.find(arvotKuustoista[b]);
			//cout << it21->second;
			//if (b == 7) cout << endl;
		}
	}
...
//	cout << "asetaTaulukko:" << pluku << ", arvo:" << arvo << endl;
	...
	// Tulosta taulukko5:en sis?lt?!

	for (auto it21 = taulukko51.begin(); it21 != taulukko51.end(); ++it21) {
	//	cout << it12->first << ",";
	//	cout << it12->second << ",";
	//	cout << endl;
	}
