...
int notti(int bitti, int numero1){
	int nr=0;
	//if(bitti == 4){
		//nr = ~numero1;
...
string lauseke_postfix2(){
	cout << "Anna lauseke postfix muodossa:" << endl;
	cin.getline(s, 100);
	string postfix(s);
	cout << "postfix: " << postfix << endl;
	muuttujatlkm = collectMlkm(postfix);
	cout << "Muuttujien lkm:" << muuttujatlkm << endl;
	postfix = concats(postfix);
	cout << "postfix:" << postfix << endl;
	mlkm2 = muuttujatlkm;
	return postfix;
}
